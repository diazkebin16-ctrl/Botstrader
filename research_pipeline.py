...
def main() -> None:
    ...
    holdout.add_argument("--input",required=True);holdout.add_argument("--phase2",required=True);holdout.add_argument("--freeze",required=True);holdout.add_argument("--output",required=True)
    ...
    if args.command=="target-population":
        ...
        elif args.command=="holdout":payload=evaluate_holdout(args.input,args.phase2,args.freeze)
