...
class SecurityManager:
    ...
    def _file_hashes(self)->Dict[str,str]:
        ...
        for name in ("server.py","security_manager.py","recovery_manager.py","order_state.py",
                     ...
                     "adaptive_learning.py","validation_pipeline.py","system_evaluation.py","governance_engine.py","production_readiness.py","smart_execution.py","instrument_registry.py","instrument_profiles.py"):
